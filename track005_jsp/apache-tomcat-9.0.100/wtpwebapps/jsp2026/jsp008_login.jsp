...
<body>
	<div class="container card  my-5">
		...
		function check(){
			...
			let pss = documaent.getElementByid("pass");
			if(email.value.trim()==""){ alert("이메일 칸을 확인해주세요"); email.focus(); retem}
			if(pass.value.trim()==""){ alert("비밀번호 칸을 확인해주세요"); pass.focus(); retem}
		 return true;	
		}
		</script>
	</div>
