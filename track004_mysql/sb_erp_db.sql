...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`company` (
  ...
  PRIMARY KEY (`com_id`),
  UNIQUE INDEX `biz_no_UNIQUE` (`biz_no` ASC) );
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`department` (
  ...
  PRIMARY KEY (`dept_id`),
  INDEX `fk_department_company1_idx` (`com_id` ASC) ,
  INDEX `fk_department_department1_idx` (`parent_id` ASC) ,
  UNIQUE INDEX `com_dept_UNIQUE` (`com_id` ASC, `dept_code` ASC) ,
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`emp_position` (
  ...
  INDEX `fk_emp_position_company1_idx` (`com_id` ASC) ,
  PRIMARY KEY (`pos_id`),
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`employee` (
  ...
  PRIMARY KEY (`emp_id`),
  INDEX `fk_employee_company1_idx` (`com_id` ASC),
  INDEX `fk_employee_emp_position1_idx` (`pos_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`authority` (
  ...
  PRIMARY KEY (`aut_id`),
  INDEX `fk_authority_company1_idx` (`com_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`emp_auth` (
  ...
  INDEX `fk_emp_auth_employee1_idx` (`emp_id` ASC),
  INDEX `fk_emp_auth_authority1_idx` (`aut_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`project` (
  ...
  PRIMARY KEY (`pro_id`),
  INDEX `fk_project_employee1_idx` (`emp_id` ASC),
  INDEX `fk_project_company1_idx` (`com_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`project_member` (
  ...
  PRIMARY KEY (`pm_id`),
  INDEX `fk_project_member_project1_idx` (`project_pro_id` ASC),
  INDEX `fk_project_member_employee1_idx` (`emp_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`task` (
  ...
  PRIMARY KEY (`task_id`),
  INDEX `fk_task_project1_idx` (`pro_id` ASC),
  INDEX `fk_task_project_member1_idx` (`pm_id` ASC),
  INDEX `fk_task_company1_idx` (`com_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`appr_form` (
  ...
  PRIMARY KEY (`for_id`),
  INDEX `fk_appr_form_company1_idx` (`com_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`appr_doc` (
  ...
  PRIMARY KEY (`doc_id`),
  INDEX `fk_appr_doc_appr_form1_idx` (`for_id` ASC),
  INDEX `fk_appr_doc_company1_idx` (`com_id` ASC),
  INDEX `fk_appr_doc_employee1_idx` (`emp_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`appr_line` (
  ...
  PRIMARY KEY (`lin_id`),
  INDEX `fk_appr_line_appr_doc1_idx` (`doc_id` ASC),
  INDEX `fk_appr_line_employee1_idx` (`emp_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`notice` (
  ...
  PRIMARY KEY (`bno`),
  INDEX `fk_notice_employee1_idx` (`emp_id` ASC),
  INDEX `fk_notice_company1_idx` (`com_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`resource` (
  ...
  PRIMARY KEY (`res_id`),
  INDEX `fk_resource_company1_idx` (`com_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sb_erp_db`.`reservation` (
  ...
  `updated_at` DATETIME NULL,
  PRIMARY KEY (`rev_id`),
  INDEX `fk_reservation_employee1_idx` (`emp_id` ASC),
  INDEX `fk_reservation_company1_idx` (`com_id` ASC),
  INDEX `fk_reservation_resource1_idx` (`res_id` ASC),
