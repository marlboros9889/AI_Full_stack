...
public class Bankproject_v4 {
	...
	public static void main(String[] args) {
		...
		//입력 //처리 //출력
		while( menu !=9 ) {
			System.out.println(id+"\t"+pass+"\t"+balance);
			...
			if (menu==9) {System.out.println("프로그램을 종료합니다");}
				...
				//변수 x
				//입력 아이디랑 비번만 입력받으면 o
				System.out.println("아이디 입력>");  id=sc.nextInt();
				System.out.println("비밀번호 입력>"); pass=sc.nextInt();
				System.out.println("잔액 입력>");    balance=sc.nextInt();
				//처리 x
				//출력 x
...
//				
//			
//			if (std == std1 && pass == pass1)
//				System.out.println("\n ID"+ std+
//						           "\n PASS"+ pass +
//						           "\n 금액" +balance);
//			else {System.out.println("PASS를 확인해주세요");} }
//			
//			else if(cas==3) {
