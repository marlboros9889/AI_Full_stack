...
<main class="sb-content">
  <%-- 관리자 전용 승인 화면: /admin/approval/list 에서 열리며 승인/반려 처리를 담당한다. --%>
  ...
  <%-- 승인 목록 페이징: 상태 필터를 유지한 채 승인 대상 페이지를 이동한다. --%>
  <nav class="mt-3">
...
<div class="modal fade" id="rejectModal" tabindex="-1" aria-hidden="true">
  <%-- 반려 모달: 선택한 예약 ID와 반려 사유를 /admin/approval/reject 로 전송한다. --%>
...
<script>
  // 반려 버튼 클릭 시 선택한 예약 ID를 모달의 숨은 필드에 넣는다.
