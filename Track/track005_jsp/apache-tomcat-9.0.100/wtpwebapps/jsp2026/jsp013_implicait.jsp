	...
	<!-- jsp013_implicit.jsp -->
		<div class=" p-5 bg-primary text-white ">
			<h3 class="card-header">001. 내장객체</h3> 	
				...
				<br/>
			      ...
			      <form action="jsp013_2.jsp"  method="get"  onsubmit="return checkbox()"  >
			        <div class="mb-3 mt-3">
			         ...
			         <div class="my-3">
			              <button  type="submit"  class="btn btn-success mt-3 d-block" >전송</button>
			         </div>                  
			      </form>
				...
				1. http 요청에 대한 응답저장 하는 객체
				2. jsp에서 다른페이지로 이동
					(1) sendRedirect      - 브라우저 url을 변경o, request/response 객체가 유지 안됨
					(2) RequestDispatcher - 위임 (요청전달)          
											브라우저 url을 변경x, request/response 객체가 유지 안됨
				</pre>
				<%
				//ver-1  알림창 처리가 안됨.
				...
				<%
				application.setAttribute("name","D.application-웹애클리케이션 실행");
				session.setAttribute    ("name","C.    session-브라우저종료/로그인후 아이디 유지");
