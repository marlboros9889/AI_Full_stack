...
export function* signup(action){
    // action = {type: signupRequest, payload: {  email:'1@1', password:'1' } }
...
//■1.takeLatest(signupRequest.type, signup)  :takeLatest - 요청이 여러번, 가장 마지막 발생요청
function* watcgSignup(){ yield takeLatest( signupRequest.type, signup );}
...
export function* fetchUser( action ){
    // action = { type:user/fechUserRequest , payload: 1 }
    try{
