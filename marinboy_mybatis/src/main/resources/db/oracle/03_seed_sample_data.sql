...
VALUES (1, 'admin', 'admin123', '원장 관리자', 'admin@marinboy.test', '010-0000-0000', 'ADMIN', NULL, NULL);

INSERT INTO MB_USER (ID, USERNAME, PASSWORD, NAME, EMAIL, PHONE, ROLE, SOCIAL_PROVIDER, SOCIAL_ID)
VALUES (2, 'customer', 'customer123', '고객 사용자', 'customer@marinboy.test', '010-1111-2222', 'CUSTOMER', NULL, NULL);

INSERT INTO MB_USER (ID, USERNAME, PASSWORD, NAME, EMAIL, PHONE, ROLE, SOCIAL_PROVIDER, SOCIAL_ID)
VALUES (3, 'seoyeon', 'customer123', '김서연', 'seoyeon@example.com', '010-1234-5678', 'CUSTOMER', NULL, NULL);
