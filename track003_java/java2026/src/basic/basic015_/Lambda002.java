...
public class Lambda002 {
	public static void main(String[] args) {
		...
		InterA2 a3 = ()->   System.out.println(" hi hi hi "); ;	    a3.hi(); //처리할일이 한줄 { } 생략 가능
		
		// interface InterA2{ void hi( String name ); }
		System.out.println("\n\n[STEP2] 매개변수x, 리턴값x");
		//2-1. 익명객체  hi Adam !!
		...
		InterB2 b3 = ( name )->      System.out.println("hi !" + name); ;   b3.hi("Delta");
		
		InterB2 b4 =  name ->         System.out.println("hi !"+ name); ;   b4.hi("yuse");
		...
		InterC2 c3= ()->         "Good :Day :Day";    System.out.println(c3.hi());
		
		// interface InterD2{ String hi( int num, String name  ); }
		System.out.println("\n\n[STEP4] 매개변수o, 리턴값o");
		//4-1. 익명객체
		InterD2 d1 = new InterD2() {
		@Override public String hi(int num, String name) { // num:별의갯수, name:이름
			String star = "";
			for(int i = 0; i < num; i++) { star += "★"; }	
			return"hi "+ name + star; 
			}
		};
		System.out.println(d1.hi(1, "Selly" ));
		System.out.println(d1.hi(2, "Selly" ));
		System.out.println(d1.hi(3, "Selly" ));
		//4-2. 람다식
		...
		System.out.println(d2.hi(22, "Selly" ));
		System.out.println(d2.hi(23, "Selly" ));
		
		InterD2 d3 = (num, name) -> { return"hi "+ name + "♥".repeat(num); 	};
		System.out.println(d3.hi (5, "Selly") );

		InterD2 d4 = (num, name)-> "hi " + name + "♣".repeat(num);
		System.out.println(d4.hi(6, "Selly") );
