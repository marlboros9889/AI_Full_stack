...
public class Poly002 {
	public static void main(String[] args) { 
		...
		// 1) 사용보장범위  : TestA2 ta= {a = 10 , toString }
		// 2) ta {a = 10 , toString } (1번지) =    1번지 {b = 20 , [ @toString }-   {a = 10   ] , ------ }  
		
		System.out.println(ta);    // TestB2 [b=20]
		System.out.println(ta.a);  // a = 10
		System.out.println(((TestB2)ta).b); // ta.b 사용방법은? b = 20
	}
}
