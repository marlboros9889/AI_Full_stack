...
class product extends Object{    //상속을 받을께, Object(클래스의 기본), Object 생략가능
	String name; int price;
	//인스턴스 변수
	public product() { super();}//super(부모)-Object() 
	
	public product(String name, int price)
	{ super(); this.name = name; this.price = price; }//this(각각의 자료)
	// this 는 각번지의 해당하는 자료
...
public static void main(String[] args) {
		...
		product p2 = new product("아이폰17" , 100); //1) new 객체생성   2)생성자-초기화  3) p2 주소갖기
		System.out.println(p2);//p2(2번지)>> 2번지 product [name=아이폰, price=100]
